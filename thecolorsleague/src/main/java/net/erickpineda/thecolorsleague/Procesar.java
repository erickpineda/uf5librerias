...
public class Procesar extends DefaultHandler {
    ...
    /**
     * Lista que se usa para almacenar cada partido, una vez finalizado se vacía
     * la lista para reutilizar la variable.
     */
    ...
    /**
     * Método que se encarga de clasificar la información del club, según los
     * datos que le llegan.
     * 
    ...
    /**
     * Método que busca el nombre de una etiqueta, si la encuentra, pondrá el valor a
     * true, cuando cierra la etiqueta será false (por defecto es false).
     * 
     * @param qName String que recibe el nombre de la etiqueta XML.
     * @param valor parámetro que se usa para cambiar las variables coincidentes a
     *            true o false según la etiqueta este abierta o cerrada.
     */
    ...
    /**
     * Método que compara la lista de {@code List<Club> partido}, para saber
     * quien gana, pierde o si empatan.
     */
    ...
    /**
     * Método que guarda la información nueva de la liga, según avanza cada
     * jornada.
     * 
     * @param c1 club local.
     * @param c2 club visitante.
